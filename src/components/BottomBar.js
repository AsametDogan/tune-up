...
function BottomBar() {
    ...
    return (
        <div className='just-sm:hidden px-4 grid grid-cols-4 gap-8 justify-around text-xl items-center bg-slate-200 fixed bottom-0 w-full h-12'>
            <button onClick={handleChangeMenu} id="home"
            ...
            <button onClick={handleChangeMenu} id="explore"
            ...
            <button onClick={handleChangeMenu} id="tune-up"
            ...
            <button onClick={handleChangeMenu} id="test"
