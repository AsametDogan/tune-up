    ...
    return (
        <div className='h-4/5'>
            <div className='flex flex-col justify-center items-center w-full h-full'>
                ...
                <form className='flex flex-col gap-4 min-w-[250px]'>
                    <input type={"text"} className='px-3 py-2 outline-none rounded-lg border border-transparent focus:border-indigo-600 bg-indigo-200 transition-all duration-200' placeholder='Nickname'></input>
